...
class MockServerContext(
    ...
    init {
        settings(io.github.infeez.kotlinmockserver.MockServerConfiguration)
        server.onDispatch = { webRequest ->
            ...
            mocks.find { mock -> mock.isCoincided(path, method, body, headers) }?.mockWebResponse ?: io.github.infeez.kotlinmockserver.MockServerConfiguration.defaultResponse
        }
    }
